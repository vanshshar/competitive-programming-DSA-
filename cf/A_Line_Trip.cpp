...
// of the number line, and you want to travel from the point 0 to the point x, and back to the point 0

// .

// You travel by car, which spends 1
// liter of gasoline per 1 unit of distance travelled. When you start at the point 0

// , your car is fully fueled (its gas tank contains the maximum possible amount of fuel).

// There are n
// gas stations, located in points a1,a2,…,an. When you arrive at a gas station, you fully refuel your car. Note that you can refuel only at gas stations, and there are no gas stations in points 0 and x
...
// , then your car's gas tank contains 3 liters of fuel. 
    ...
    int main() {
        ...
        while(t--) {
            ...
            for(int i=0; i<a.size() - 1; i++) {
                ...
                int lastTox = a[a.size() - 1] - a[a.size() - 2];
                maxi = max(maxi , 2 * lastTox);
            cout<<maxi<<"\n";
        }
        return 0;
    }